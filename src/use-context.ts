...
export type ContextName = string | { name: string; key: string | symbol };

export type ContextValue<T> = T extends (...args: any[]) => any ? ReturnType<T> : T;

export type ContextProvider<T> = T extends (...args: any[]) => any ? T : (arg: T) => T;

export type ContextConsumer<Context> = <N extends string | null | undefined = undefined>(
  consumerName?: N,
